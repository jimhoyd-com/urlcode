...
export function patched(/** @type {string} */ version) { const [a = 0, b = 0, c = 0] = String(version).split('.').map(Number); return a > 3 || a === 3 && (b > 51 || b === 51 && c >= 3 || b === 50 && c >= 7 || b === 44 && c >= 6); }
export function check(/** @type {string} */ version) {
