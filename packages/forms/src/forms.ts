...
export interface FormFlowSpec { mount:string; title:string; submitLabel:string; confirmation:{title:string; message:string; show?:string[]}; fields:Record<string,FormFieldSpec> }
