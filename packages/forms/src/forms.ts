...
export interface FormFieldSpec { label:string; control?:Control; type?:InputType; required?:boolean; minLength?:number; maxLength?:number; minimum?:number|string; maximum?:number|string; pattern?:string; enum?:string[]; options?:FormOption[]; description?:string; requiredWhen?:RequiredWhen }
