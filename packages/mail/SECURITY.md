...
| Bounded delivery | One global `maxConcurrent` (default 8; `busy` at once when full), a per-message deadline (default 5 s) that aborts the transport, and SES at most two attempts. |
