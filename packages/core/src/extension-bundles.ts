...
import { type UnknownRecord as RecordValue, isRecord as record, digestHex as digest, textField, exactKeys as sharedExactKeys, listCachedFiles, writeLockAtomic, createGithubTransport, verifiedReleaseAsset, type ReleaseAsset } from './extension-transport.ts';
...
async function verified(assets:ReleaseAsset[],asset:string,release:string,transport:BundleTransport):Promise<Uint8Array>{return verifiedReleaseAsset(assets,asset,release,transport,'extension bundle','urlcode-bundle-attest');}
/**
