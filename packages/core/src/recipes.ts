...
export const recipeNames=['redirect','json-endpoint','json-api','typescript','middleware','health-page','static-page','static-plus-api','cors-api','webhook-receiver','contact-form','authenticated-json-api','protected-download','store-crud','streaming-progress'] as const;
