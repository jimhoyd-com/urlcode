...
.ui-textarea{height:auto;min-height:6rem;resize:vertical;line-height:1.5}
...
/* shadcn skill composition pass: FieldGroup auth, inset Sidebar, full Card anatomy, semantic Empty/Badge/Table. */
.ui-body[data-layout=compact]{background:hsl(var(--muted))}.ui-body[data-layout=compact] .ui-header{border:0;background:transparent}.ui-body[data-layout=compact] .ui-header-row{justify-content:center;padding-top:2.5rem}.ui-body[data-layout=compact] .ui-header+.ui-main{margin-top:1.5rem}.ui-body[data-layout=compact] .ui-main{max-width:26rem;padding:2rem;border-radius:calc(var(--radius) + .25rem);box-shadow:0 8px 24px hsl(var(--foreground)/.06)}.ui-body[data-layout=compact] .ui-title{text-align:center;margin-bottom:.5rem}.ui-body[data-layout=compact] .ui-intro{text-align:center;margin:0 0 1.5rem}.ui-body[data-layout=compact] .ui-field label{line-height:1.25}.ui-body[data-layout=compact] .ui-actions{margin-top:.25rem}.ui-body[data-layout=compact] .ui-link-list{margin-bottom:0}.ui-auth-primary,.ui-auth-alternatives{display:flex;flex-direction:column;gap:1rem}.ui-auth-alternatives:not(:has(form)){display:none}.ui-field-separator{display:flex;align-items:center;gap:.75rem;margin:1.25rem 0;color:hsl(var(--muted-foreground));font-size:.75rem;text-transform:uppercase;letter-spacing:.08em}.ui-field-separator::before,.ui-field-separator::after{content:"";height:1px;flex:1;background:hsl(var(--border))}.ui-field-separator:has(+.ui-auth-alternatives:not(:has(form))){display:none}.ui-auth-alternatives form,.ui-auth-alternatives fieldset{margin:0}.ui-auth-alternatives fieldset{padding:0;border:0}.ui-auth-alternatives legend{font-size:.875rem;font-weight:500;margin-bottom:.5rem}.ui-auth-alternatives button{width:100%;margin-top:.5rem;background:hsl(var(--background));color:hsl(var(--foreground));border:1px solid hsl(var(--border));box-shadow:0 1px 2px hsl(var(--foreground)/.04)}.ui-auth-alternatives button:hover{background:hsl(var(--accent));color:hsl(var(--accent-foreground))}
.ui-field[data-invalid=true] label{color:hsl(var(--destructive))}.ui-field[data-invalid=true] .ui-input{border-color:hsl(var(--destructive))}.ui-button>.ui-icon[data-icon]{margin-inline:0}.ui-empty[data-slot=empty]{display:flex;min-height:8rem;flex-direction:column;align-items:center;justify-content:center;gap:.75rem;background:hsl(var(--muted)/.35);border-style:dashed}.ui-empty[data-slot=empty] p{margin:0}.ui-empty[data-slot=empty] [data-slot=empty-header]{display:flex;flex-direction:column;align-items:center;gap:.25rem}.ui-empty[data-slot=empty] [data-slot=empty-content]{margin-top:.25rem}
.ui-body[data-layout=application]{background:hsl(var(--sidebar))}.ui-shell{grid-template-columns:16rem minmax(0,1fr);gap:.5rem;padding:.5rem;background:hsl(var(--sidebar))}.ui-sidebar{height:calc(100vh - 1rem);padding:1.25rem .75rem;border:0;border-radius:calc(var(--radius) + .25rem)}.ui-sidebar>.ui-brand{min-height:2.5rem}.ui-sidebar-nav a[aria-current]{box-shadow:none;background:hsl(var(--sidebar-foreground)/.09)}.ui-content{max-width:none;min-height:calc(100vh - 1rem);margin:0;padding:0 2rem 2rem;background:hsl(var(--background));border:1px solid hsl(var(--border));border-radius:calc(var(--radius) + .4rem);overflow:hidden}.ui-page-header{min-height:4rem;margin:0 -2rem 1.5rem;padding:1rem 2rem;border-bottom:1px solid hsl(var(--border));background:hsl(var(--background)/.96)}.ui-page-header h1{font-size:1.25rem}.ui-card{border-radius:calc(var(--radius) + .25rem);box-shadow:0 1px 2px hsl(var(--foreground)/.04)}.ui-card-header{padding:1.25rem 1.25rem 0}.ui-card-content{padding:1.25rem}.ui-card-footer{padding:0 1.25rem 1.25rem}.ui-metrics{gap:.75rem;margin-bottom:1rem}.ui-metric{position:relative;min-height:8.5rem;gap:.5rem;padding:1.25rem}.ui-metric:hover{background:hsl(var(--accent)/.4)}.ui-metric-label{font-size:.8125rem;color:hsl(var(--muted-foreground))}.ui-metric-value{font-size:2rem;font-weight:600;letter-spacing:-.05em;line-height:1.1}.ui-metric-link{position:absolute;inset-inline-end:1.25rem;bottom:1.25rem;color:hsl(var(--muted-foreground))}.ui-chart{padding:0}.ui-chart .ui-card-header{align-items:flex-start;margin:0}.ui-chart .ui-card-content{padding-top:1rem}.ui-chart svg{max-height:20rem}.ui-chart-legend{padding-top:1rem}.ui-recent-card .ui-card-header{margin:0}.ui-recent-card .ui-card-content{padding-top:.5rem}.ui-recent-card .ui-button{height:2rem;padding:.25rem .625rem}.ui-activity code{font-size:.8125rem}.ui-dashboard-details>summary{padding:1.25rem}.ui-dashboard-details[open]>summary{margin:0;border-bottom:1px solid hsl(var(--border))}.ui-dashboard-details>.ui-card-content{padding-top:.25rem}.ui-table-wrap{border-radius:calc(var(--radius) + .125rem);box-shadow:0 1px 2px hsl(var(--foreground)/.025)}.ui-table thead{background:hsl(var(--muted)/.5)}.ui-table tbody tr:last-child th,.ui-table tbody tr:last-child td{border-bottom:0}.ui-badge[data-slot=badge]{background:hsl(var(--secondary));color:hsl(var(--secondary-foreground))}
.ui-sidebar .ui-nav>ul{width:100%;flex-direction:column;flex-wrap:nowrap}.ui-sidebar .ui-nav li,.ui-sidebar .ui-nav a{width:100%}
@media(max-width:1000px){.ui-shell{grid-template-columns:13.5rem minmax(0,1fr)}.ui-content{padding-inline:1.5rem}.ui-page-header{margin-inline:-1.5rem;padding-inline:1.5rem}}
