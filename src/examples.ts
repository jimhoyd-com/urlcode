...
export const exampleNames=['assets','aws','cloudflare','compliance','conditions','cookbook','coverage-waiver','data-dir','egress','extensions','lifecycle','monitoring','prerender','provider-conformance','shared-blocks','tunnel','vercel'] as const;
