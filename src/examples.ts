...
export const exampleNames=['assets','aws','cloudflare','compliance','conditions','cookbook','data-dir','egress','extensions','monitoring','prerender','provider-conformance','tunnel','vercel'] as const;
