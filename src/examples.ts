...
export const exampleNames=['assets','aws','cloudflare','compliance','conditions','cookbook','data-dir','egress','extensions','monitoring','prerender','provider-conformance','shared-blocks','tunnel','vercel'] as const;
