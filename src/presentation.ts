...
export const baseCatalogue: Readonly<Catalogue> = Object.freeze({'nav.skip':'Skip to content','action.next':'Next page','action.previous':'Previous page','message.empty':'Nothing to show'});
