...
export default tseslint.config(
  ...
  // packages/ui/src/styles.generated.ts and src/kit-styles.generated.ts are
  // `npm run workspace:styles` output (gitignored, generated stylesheet
  // string literals), present on disk by the time `static`'s CI job lints;
  // they are not authored source.
  { ignores: ['**/node_modules/**', '**/coverage/**', '**/dist/**', '.claude/worktrees/**', 'packages/ui/src/styles.generated.ts', 'packages/ui/src/kit-styles.generated.ts'] },
