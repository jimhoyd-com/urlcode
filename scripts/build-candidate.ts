...
// JSON boundary: only the typescript pin is read from the lockfile.
const lock=JSON.parse(await readFile('package-lock.json','utf8')) as {packages?: Record<string,{version?: string}|undefined>};
