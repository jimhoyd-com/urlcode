...
const packageNames=['ui','auth','admin','store'] as const;
...
function dependencySet(bundle:BundleName):BundleName[]{return bundle==='ui'?['ui']:bundle==='auth'?['ui','auth']:bundle==='admin'?['ui','auth','admin']:['store'];}
