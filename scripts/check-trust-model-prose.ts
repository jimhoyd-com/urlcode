...
const PROJECT_ROOTS = ['examples/', 'starters/', 'recipes/', 'packages/core/src/', 'scripts/', 'packages/', 'test/'];
...
const RULES: Rule[] = [
  {
    ...
    // default. Fixed by hand in docs/POLICIES.md and packages/core/src/policies.ts before any
