...
await writeFile('candidate/manifest.json',JSON.stringify({sourceCommit,node:process.version,versions:process.versions,lockfileSha256:digest(await readFile('package-lock.json')),artifacts,channel,version:pkg.version,license:pkg.license},null,2)+'\n');
