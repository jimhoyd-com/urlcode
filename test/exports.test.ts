...
const expected: Record<string, string[]> = {
  '.': ['createRuntime','startServer','loadDocument','validateDocument','parseYaml','openLinkStore','startLinkApi','observabilityEvents','createMetrics','renderPrometheus','getCapabilities','importRoutes','exportRoutes','listRecipes','buildTypeScriptProject','importBulkProject','inspectProject','serveMcp','verifyProviderDeployment','matchesRoute','buildCloudflare','runProjectTests','scaffoldProject','initProject','addRedirect','initProjectWith'],
