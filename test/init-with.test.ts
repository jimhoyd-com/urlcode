...
test('init --with refuses duplicate extension routes, missing packages and packages without scaffold before writing anything', async t => {
  ...
  const cases: [string, RegExp][] = [
    ...
    ['auth,auht', /Unknown extension bundle auht; did you mean auth\? Known bundles: ui, ui-presentation, auth, admin, store, forms, mcp/], ['zzz', /Unknown extension bundle zzz\. Known bundles:/],
  ];
