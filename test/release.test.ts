...
test('the released version is stated consistently across the CLI and installer', async () => {
  ...
  assert.match((await read('packages/core/src/cli.ts')),new RegExp(`const VERSION = '${pattern(pkg.version)}'`),
    'packages/core/src/cli.ts VERSION constant does not state package.json version');
