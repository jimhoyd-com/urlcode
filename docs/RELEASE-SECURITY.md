...
URLCode 0.1.0 is the Apache-2.0 stable self-hosted baseline. The workflow described
here produces a **signed build candidate**; it does not publish an npm/Homebrew
package, container image or GitHub release. Licensing is defined in [LICENSE](../LICENSE).
