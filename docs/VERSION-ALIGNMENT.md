...
The `0.4.6` release is an explicit stable release decision for core, UI, auth
and admin. Publication moves each package's npm `latest` channel to `0.4.6`, in
...
After all four `0.4.6` versions are published, install the aligned set with:

```sh
npm install --save-exact @jimhoyd/urlcode@0.4.6 @jimhoyd/urlcode-ui@0.4.6 @jimhoyd/urlcode-auth@0.4.6 @jimhoyd/urlcode-admin@0.4.6
```
