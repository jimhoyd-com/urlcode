...
```sh
git clone --branch v0.4.6 https://github.com/jimhoyd-com/urlcode.git
docker build -t urlcode:0.4.6 urlcode
docker run --rm -p 127.0.0.1:3000:3000 -v "$PWD:/project:ro" urlcode:0.4.6 \
