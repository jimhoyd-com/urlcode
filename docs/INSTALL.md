...
```sh
git clone --branch v0.5.3 https://github.com/jimhoyd-com/urlcode.git
docker build -t urlcode:0.5.3 urlcode
docker run --rm -p 127.0.0.1:3000:3000 -v "$PWD:/project:ro" urlcode:0.5.3 \
